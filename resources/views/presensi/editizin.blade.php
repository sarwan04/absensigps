    ...
    <div class="col">
        <form action="{{ url('/presensi/'.$izin->id.'/update') }}" method="POST" id="formizin">
            ...
            <div class="form-group">
                <input type="text" id="tgl_izin" name="tgl_izin" class="form-control datepicker" value="{{ $izin->tgl_izin }}" placeholder="Tanggal" required>
            </div>
            ...
            <div class="form-group">
                <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" placeholder="Keterangan" maxlength="255" oninput="updateCharCount()" required>{{ $izin->keterangan }}</textarea>
