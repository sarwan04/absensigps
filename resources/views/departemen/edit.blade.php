    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->kode_dept }}" id="kode_dept" class="form-control" placeholder="Kode Jabatan" name="kode_dept" readonly maxlength="5">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->nama_dept }}" id="nama_dept" class="form-control" name="nama_dept" placeholder="Nama Jabatan" maxlength="50">
            </div>
        </div>
    </div>
