                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="nama_dept" id="nama_dept" class="form-control" placeholder="Jabatan" value="{{ Request('nama_dept')}}">
                                            </div>
                                        </div>
                                        ...
                                        @foreach ($departemen as $d)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="#" class="edit btn btn-primary btn-md mr-2" kode_dept="{{ $d->kode_dept }}" ><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg></a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="kode_dept" class="form-control" placeholder="Kode Jabatan" name="kode_dept" maxlength="5" required oninvalid="this.setCustomValidity('Kode jabatan tidak boleh kosong!')" oninput="setCustomValidity('')">
                          </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nama_dept" class="form-control" name="nama_dept" placeholder="Nama Jabatan" maxlength="50" required oninvalid="this.setCustomValidity('Nama jabatan tidak boleh kosong!')" oninput="setCustomValidity('')">                     
                          </div>
                    </div>
                </div>
