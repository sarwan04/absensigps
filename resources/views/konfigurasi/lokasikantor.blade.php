                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" value="{{ $lok_kantor->lokasi_kantor }}" id="lokasi_kantor" class="form-control" name="lokasi_kantor" placeholder="Lokasi Kantor" maxlength="250">
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="number" value="{{ $lok_kantor->radius }}" id="radius" class="form-control" name="radius" placeholder="Radius" maxlength="5">
                                      </div>
                                </div>
                            </div>
